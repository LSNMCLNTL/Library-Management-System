...
if(!empty($first_name_err) || !empty($last_name_err) || !empty($password_err) || !empty($username_err) || !empty($contact_no_err)){
    ...
    $sql = "INSERT INTO admin (first_name, last_name, password, username, contact_no) VALUES (?, ?, ?, ?, ?)";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add an admin record to the database.</p>
