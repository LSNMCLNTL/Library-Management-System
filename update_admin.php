...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_contact_no)){
        $contact_no_err = "Please enter the admin's contact no.";     
    ...
    if(empty($first_name_err) && empty($last_name_err) && empty($username_err) && empty($password_err) && empty($contact_no_err)){
        ...
        $sql = "UPDATE admin SET first_name=?, last_name=?, username=?, password=?, contact_no=? WHERE admin_id=?";
         
        if($stmt = mysqli_prepare($conn, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssi", $param_first_name, $param_last_name, $param_username, $param_password, $param_contact_no, $param_id);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please edit the input values and submit to update the admin's record.</p>
